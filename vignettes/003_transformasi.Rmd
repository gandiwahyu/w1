...
table4b_tidy <- table4b %>% gather(key = "year", value = "population", 2:3)
table4b_tidy
```
...
1. data who, ubah dari format wide format ke long format
2. pilih kolom country, year case
3. dikelompokan by country, year
4. menghitung jumlah total kasusnya
5. menghilangkan fungsi group sebeumya
6. menggabungkan dua table
7. memfilter baris yang population tidak na
8. membuat kolom baru proportion dengan rumus (100*cases/population)
